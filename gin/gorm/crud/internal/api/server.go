...
import (
	...
	"github.com/yizeng/gab/gin/gorm/crud/docs"
	v1 "github.com/yizeng/gab/gin/gorm/crud/internal/api/handler/v1"
	"github.com/yizeng/gab/gin/gorm/crud/internal/api/middleware"
	"github.com/yizeng/gab/gin/gorm/crud/internal/config"
	"github.com/yizeng/gab/gin/gorm/crud/internal/repository"
	"github.com/yizeng/gab/gin/gorm/crud/internal/repository/dao"
	"github.com/yizeng/gab/gin/gorm/crud/internal/service"
)
